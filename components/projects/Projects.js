    ...
    useEffect(() => {
        setProjects([
            ...
            },
            {
                "id": "3",
                "title": "ColorHueState",
                "description": "is an on-chain image machine rendering the heartbeat of the Ethereum blockchain.",
                "url": "https://colorhuestate.xyz/",
            },
            {
                "id": "4",
                "title": "SHIFT",
                "description": "is a performance-based media artwork transcoding work wear into digital wearables.",
            ...
            , {
                "id": "6",
                "title": "wom3n.dao",
                "description": "I'm supporting the female founders circle as a tech lead in all DAO-specific questions.",
                "url": "https://wom3n.io",
            },
            {
                "id": "7",
                "title": "SystAIn3r",
                "description": "I'm fellow of this network of pioneering women in AI, Web3, and sustainability.",
    ...
    return (
        <div id="awards" className="block spacer p-top-xl">
            <div className="wrapper">
                ...
                <h2>
                    My favourite <span className="line">Projects</span> and <span className="line">Collabs</span>
                </h2>
            </div>
